...
//        Person p = gson.fromJson(json,Person.class);
        ...
        return new JsonResponse(rulesService.getRulesWrite(id,json));
//        return new JsonResponse(rulesService.getRulesWrite(id,p));
    ...
    @ApiImplicitParam(name = "id", dataType = "int", required = true, value = "规则编号")
    @RequestMapping(value = "/delete", method = RequestMethod.POST, produces = "application/json;charset=UTF-8")
    public JsonResponse delete(@RequestParam("id") Integer id) {
        return new JsonResponse(rulesService.deleteRule(id)
        );
    }
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "rule", dataType = "string", required = true, value = "规则"),
            @ApiImplicitParam(name = "id", dataType = "int", required = true, value = "规则id"),
            @ApiImplicitParam(name = "name", dataType = "string", required = true, value = "规则名称")})
