package com.purcotton.omni.promotion.rule.rule.complexProblem;

import com.purcotton.omni.promotion.rule.bean.Student1;
        ...
        for (String n : names) {
            for (String w1 : word1) {
                for (String w2 : word2) {
                    for (int d1 : desc1) {
                        for (int d2 : desc2) {
                            Student1 student = new Student1(n, w1, w2, d1, d2);
